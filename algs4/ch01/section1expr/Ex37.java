...
public class Ex37 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Result shows that all elements' value don't approximate N/M.
         * So the resulting order is not equally likely to be one of the N! possibilities.
         */
